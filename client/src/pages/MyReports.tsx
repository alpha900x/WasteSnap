 ...
 const { data: reports = [] } = useQuery({
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">My Reports</h2>
          <p className="text-slate-600 dark:text-slate-400">Track the status of your submitted reports</p>
        </div>
